 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | mute | Ctrl | Alt  | GUI  |Lower |Shift |Space |Raise |rShift| rAlt |rCtrl | Copy |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_MUTE,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_LSFT, KC_SPC,  RAISE,   KC_RSFT, KC_RALT, KC_RCTL, KC_COPY
),
