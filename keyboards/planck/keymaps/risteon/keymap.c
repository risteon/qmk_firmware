...
/* Window
 * ,-----------------------------------------------------------------------------------.
 * | CAPS |      |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Del  | Quit |   )  |   {  |   }  |      |      |  <-  |  =+  |   [  |   ]  |  \   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |ADJUST|      |ISO / |Pg Dn |Pg Up |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_WINDOW] = LAYOUT_planck_grid(
    _______, _______,          KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
    _______,  LGUI(LSFT(KC_Q)),          KC_RPRN, KC_LCBR, KC_RCBR, _______, _______, LGUI(KC_H), KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, _______,          _______, _______, _______, _______, ADJUST,  _______, KC_NUBS, KC_PGDN, KC_PGUP, _______,
    _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Exit |      |MUSmod|Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|Numpad|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    EXT_ADJ, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  DVORAK,  NUMPAD,  _______,
