...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    LALT_T(KC_ESC),  KC_A,     KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    RALT_T(KC_QUOT),
    KC_MINS, KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    LALT_T(KC_ESC),  KC_A,     KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    RALT_T(KC_SLSH),
    KC_MINS, KC_SCLN,  KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_ENT ,
    KC_MUTE,  KC_LCTL, KC_LALT, KC_LCTL, LOWER,   KC_LSFT, KC_SPC,  RAISE,   KC_LGUI, KC_RALT, KC_RCTL, KC_COPY
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_BRID, KC_BRIU,       _______,       _______,       _______,       LCTL(KC_LSFT),  _______,       _______,       KC_VOLD, KC_VOLU, KC_RSFT
),
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    EXT_NUM, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_P0, KC_PCMM, KC_PEQL, KC_PSLS, KC_NUM
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Exit |      |MUSmod|Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    EXT_ADJ, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, _______,
