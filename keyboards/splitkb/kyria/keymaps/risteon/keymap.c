 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                     | Mute |Ctrl(Esc)|Lower |Shift |      |  |      |Space |Raise |GUI/Bk|      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_QWERTY] = LAYOUT(
 ...
 */
 ...
 KC_GRV,KC_RGUI,OSM(MOD_RCTL),OSM(MOD_LALT),OSM(MOD_LSFT),OSM(MOD_RALT),                        KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_TILD, KC_PIPE,
      KC_PSCR, KC_F1,   KC_F2,    KC_F3,    KC_F4,   KC_F5, _______, _______, _______, _______, KC_F6,   KC_GRV , KC_PIPE, KC_HOME, KC_END,  _______,
 ...
 */
    [_RAISE] = LAYOUT(
      ...
      _______,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11, _______, _______, _______, _______, KC_F12,  KC_QUOT, KC_NUBS, KC_PGDN, KC_PGUP, _______,
 ...
 */
 ...
 LGUI(LSFT(KC_E)),LGUI(LSFT(KC_Q)),LGUI(KC_SPC),OSM(MOD_LALT),OSM(MOD_LSFT),OSM(MOD_RALT),          LGUI(LSFT(KC_LEFT)),LGUI(LSFT(KC_DOWN)),LGUI(LSFT(KC_UP)),LGUI(LSFT(KC_RGHT)),LGUI(LSFT(KC_E)),_______,
      _______, KC_BRID, KC_BRIU, KC_VOLD, KC_VOLU, OSM(MOD_LCTL), _______, _______, _______, _______, ADJUST_HOLD, _______, KC_PSCR, KC_INS, KC_CAPS, _______,
                                  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
